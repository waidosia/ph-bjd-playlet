...
class Settings(QDialog, Ui_Settings):
    ...
    def getSettings(self):
        ...
        self.dreamCookie.setText(get_settings("dreamCookie"))
        self.playetCookie.setText(get_settings("playetCookie"))
    ...
    def updateSettings(self):
        ...
        update_settings("dreamCookie", str(self.dreamCookie.text()))
        update_settings("playetCookie", str(self.playetCookie.text()))
